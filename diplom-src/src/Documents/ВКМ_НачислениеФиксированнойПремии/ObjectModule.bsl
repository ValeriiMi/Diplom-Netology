...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	// 1. Формируем движения дополнительных начислений
	...
	// 2. Формируем движения удержаний
	СформироватьДвиженияУдержаний();
	
	// 3. Формируем движения по регистру ВКМ_ВзаиморасчетыССотрудниками
...
Процедура СформироватьДвиженияУдержаний()
	...
	|	ВКМ_УдержанияБазаВКМ_ДополнительныеНачисления.НомерСтрокиРазрез КАК НомерСтрокиРазрез,
	...
	|	ВКМ_УдержанияБазаВКМ_ДополнительныеНачисления.НомерСтрокиРазрез,
